...
public class Calculator {
	...
	void setAdditionService(MathService Add) {
		this.Add=Add;
	}
	
	@Autowired
	@Qualifier ("subtractionService")
	void setSubtractionService(MathService Sub) {
		this.Sub=Sub;
	}
	
	@Autowired
	@Qualifier ("multiplicationService")
	void setMultiplicationService(MathService Multiply) {
		this.Multiply=Multiply;
	}
	
	@Autowired
	@Qualifier("divisionService")
	void setDivisionService(MathService Divide) {
		this.Divide=Divide;
	}
